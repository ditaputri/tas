...
<html lang="en">
	...
	<body>
										...
										<div class="cart-list">
											<div class="product-widget">
												<div class="product-img">
													<img src="<?php echo base_url('assets_home/')?>img/product01.png" alt="">
												</div>
											...
											<div class="product-widget">
												<div class="product-img">
													<img src="<?php echo base_url('assets_home/')?>img/product02.png" alt="">
												</div>
												<div class="product-body">
													<h3 class="product-name"><a href="#">product name goes here</a></h3>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo base_url('assets_home/')?>img/shop01.png" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo base_url('assets_home/')?>img/shop03.png" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="<?php echo base_url('assets_home/')?>img/shop02.png" alt="">
							</div>
							<div class="shop-body">
							...
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											<div class="product-img">
												<img src="<?php echo base_url('assets_home/')?>img/product06.png" alt="">
										...
										<div class="product">
											<div class="product-img">
												<img src="<?php echo base_url('assets_home/')?>img/product07.png" alt="">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="<?php echo base_url('assets_home/')?>img/product08.png" alt="">
												<div class="product-label">
													<span class="sale">-30%</span>
												</div>
											</div>
										...
										<div class="product">
											<div class="product-img">
												<img src="<?php echo base_url('assets_home/')?>img/product09.png" alt="">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo base_url('assets_home/')?>img/product03.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo base_url('assets_home/')?>img/product04.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="<?php echo base_url('assets_home/')?>img/product05.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
		...
		<script src="<?php echo base_url('assets_home/') ?>js/slick.min.js"></script>
		<script src="<?php echo base_url('assets_home/') ?>js/nouislider.min.js"></script>
		<script src="<?php echo base_url('assets_home/') ?>js/jquery.zoom.min.js"></script>
